...
function listen(e) {
    e.addEventListener("click", function() {
        alert.style.display = "none", localStorage.setItem("GPACalculatorAlertStatus--GPALaunch", "hide")
    })
}
var menu = {
    menuIsOpen: !1,
    toggleMenu: function() {
        var e = document.body;
        menu.menuIsOpen ? e.classList.remove("menu-is-open") : e.classList.add("menu-is-open"), menu.menuIsOpen = !menu.menuIsOpen
    },
    init: function() {
...
var converter = {
        ...
        if (e.classList.contains("js-converter-gradeScale")) {
            ...
            try {
                for (var u, d = function() {
                    ...
                    }, g = n[Symbol.iterator](); !(c = (u = g.next()).done); c = !0) d()
            } catch (e) {
                o = !0, i = e
            } finally {
                try {
            ...
            t ? (console.log("HI"), r.selectedIndex = s.selectedIndex = parseFloat(t)) : r.value = s.value = m
        } else r.selectedIndex = s.selectedIndex = e.selectedIndex, l.value = a.toFixed(1);
        r.classList.add("is-selected"), s.classList.add("is-selected")
    },
    ...
    init: function() {
        if (document.body.dataset.converter) {
            ...
            e.value = document.body.dataset.converter, converter.convert(e, document.body.dataset.converterIndex)
        }
...
var calculator = {
    ...
    createItem: function(e) {
        ...
        a.appendChild(r), calculator.updateLocalStorage(e.target, "create")
    },
    removeItem: function(e) {
        var t = e.target.parentNode,
            a = e.target.parentNode.parentNode;
        calculator.updateLocalStorage(e.target, "remove"), a.removeChild(t), calculator.calculate()
    },
    updateItem: function(e) {
        if (e && e.target.classList.contains("js-select-gradeLetter")) {
            var t = e.target.parentNode,
                a = t.getElementsByClassName("js-select-gradePercent")[0];
            e.target.classList.add("is-selected"), a.classList.add("is-selected"), a.value = e.target.value
        } else if (e && e.target.classList.contains("js-select-gradePercent")) {
            var t = e.target.parentNode,
                l = t.getElementsByClassName("js-select-gradeLetter")[0];
            e.target.classList.add("is-selected"), l.classList.add("is-selected"), l.value = e.target.selectedOptions[0].dataset.letterValue
        }
    },
    toggleWeight: function(e) {
        ...
        calculator.weightIsOff = !calculator.weightIsOff, calculator.calculate(), calculator.updateLocalStorage(e, "update")
    },
    ...
    calculateGPA: function() {
        ...
        try {
            for (var o, i = function() {
                    ...
                    try {
                        for (f = t[Symbol.iterator](); !(d = (y = f.next()).done); d = !0) {
                            var c = y.value,
                                ...
                                v = parseFloat(c.getElementsByClassName("js-course-credits")[0].value) || 3;
                            if (i >= 0 && c.getElementsByClassName("js-course-grade")[0].classList.add("is-selected"), u >= 0 && c.getElementsByClassName("js-course-weight")[0].classList.add("is-selected"), i >= 0 && v > 0) {
                                var p = 0;
                                p = !calculator.weightIsOff && u > 0 ? (i + u) * v : i * v, s += p, n += v
                            }
                        }
                    } catch (e) {
                        g = !0, m = e
                    ...
                    a = s / n, a = isNaN(a) ? 0 : Math.round(100 * a) / 100;
                    var h = e.getElementsByClassName("js-semester-gpa")[0],
                        L = h.innerHTML;
                    h.innerHTML = a.toFixed(2), h.classList.remove("is-below"), h.classList.remove("is-above"), L && a < L ? (h.classList.add("is-below"), setTimeout(function() {
                        h.classList.remove("is-below")
                    }, 1500)) : L && a > L && (h.classList.add("is-above"), setTimeout(function() {
    ...
    calculateGrade: function(e) {
        ...
        if (e && e.target.classList.contains("js-assessment-gradeLetter")) {
            ...
            e.target.classList.add("is-selected"), r.classList.add("is-selected"), r.value = e.target.value, calculator.updateLocalStorage(r, "update")
        } else if (e && e.target.classList.contains("js-assessment-gradePercent")) {
            var l = e.target.parentNode,
                s = l.getElementsByClassName("js-assessment-gradeLetter")[0];
            e.target.classList.add("is-selected"), s.classList.add("is-selected"), s.value = e.target.selectedOptions[0].dataset.letterValue, calculator.updateLocalStorage(s, "update")
        }
        var n = !0,
            c = !1,
            o = undefined;
        try {
            for (var i, u = a[Symbol.iterator](); !(n = (i = u.next()).done); n = !0) {
                ...
                f > 100 ? alert("Total weight (percentages) cannot exceed 100.") : (g = m / f, isNaN(g) || (g = Math.round(100 * g), d.getElementsByClassName("js-class-grade")[0].innerHTML = g))
            }
        } catch (e) {
            c = !0, o = e
        } finally {
    ...
    calculateFinalGrade: function(e) {
        var t = document.getElementById("js-calculator-gradeCurrent"),
            ...
            s = undefined;
        "calculate" == e.target.dataset.action ? (s = (a.value - t.value * (1 - r.value / 100)) / (r.value / 100), l.innerHTML = Math.ceil(s)) : "reset" == e.target.dataset.action && (t.value = a.value = r.value = l.innerHTML = "")
    },
    render: function(e) {
        var t = undefined,
            a = undefined,
            l = undefined;
        "gpa" == calculator.type ? (t = document.getElementById("js-semesters"), a = "semester", l = "course") : "grade" == calculator.type && (t = document.getElementById("js-classes"), a = "class", l = "assessment");
        var r = !0,
            s = !1,
            n = undefined;
        try {
        ...
        if (document.getElementsByClassName("js-weight-toggle")) {
            ...
            localStorage.getItem("gpa-data") && "weightIsOff" in JSON.parse(localStorage.getItem("gpa-data")) && (calculator.weightIsOff = JSON.parse(localStorage.getItem("gpa-data")).weightIsOff), document.body.classList.contains("college-gpa-calculator") ? calculator.weightIsOff || calculator.toggleWeight(O[0], "update") : document.body.classList.contains("high-school-gpa-calculator") && calculator.weightIsOff && calculator.toggleWeight(O[0], "update");
            var T = !0,
                x = !1,
                A = undefined;
            try {
                for (var M, P = O[Symbol.iterator](); !(T = (M = P.next()).done); T = !0) {
                    ...
                    F.checked = !calculator.weightIsOff, F.id = J, F.parentNode.getElementsByTagName("label")[0].setAttribute("for", J)
                }
            } catch (e) {
                x = !0, A = e
            } finally {
    ...
    getLocalStorage: function() {
        ...
        t || (t = calculator.setLocalStorage(calculator.type, e)), calculator.render(JSON.parse(t))
    },
    setLocalStorage: function() {
        var e = calculator.type + "-calculator",
            t = [];
        return "gpa" == calculator.type ? t = [calculator.semesterTemplate] : "grade" == calculator.type && (t = [calculator.klassTemplate]), localStorage.setItem(e, JSON.stringify(t)), localStorage.getItem(e)
    },
    updateLocalStorage: function(e, t) {
        ...
        if ("create" == t) "course" == e.dataset.type ? l[n].push(calculator.courseTemplate) : "semester" == e.dataset.type ? l.push(calculator.semesterTemplate) : "assessment" == e.dataset.type ? l[n].push(calculator.assessmentTemplate) : "class" == e.dataset.type && l.push(calculator.klassTemplate), localStorage.setItem(a, JSON.stringify(l));
        else if ("remove" == t) "LI" == c.tagName ? l[i].splice([n], 1) : l.splice([n], 1), localStorage.setItem(a, JSON.stringify(l));
        else if ("update" == t) {
            var u = e.dataset.type,
                d = e.value;
            if ("weightToggle" == u) l = JSON.parse(localStorage.getItem("gpa-data")) || {}, l.weightIsOff = calculator.weightIsOff, localStorage.setItem("gpa-data", JSON.stringify(l));
            else if ("currentGrade" == u || "currentCredits" == u) l = JSON.parse(localStorage.getItem("gpa-data")) || {}, l[u] = parseFloat(d), localStorage.setItem("gpa-data", JSON.stringify(l));
            else {
                var g = l[i][n],
                    m = !0,
                    f = !1,
    ...
    init: function() {
        "gpa" != calculator.type && "grade" != calculator.type || calculator.getLocalStorage(), document.addEventListener("input", function(e) {
            e.target && e.target.classList.contains("js-calculate") ? calculator.calculate(e) : e.target && e.target.classList.contains("js-item-update") && calculator.updateItem(e), e.target && e.target.classList.contains("js-store") && calculator.updateLocalStorage(e.target, "update")
        }), document.addEventListener("click", function(e) {
...
alert && "hide" == alertStatus && (alert.style.display = "none"), alertActions.forEach(listen);